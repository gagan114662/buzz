...
| Open Interpreter | [openinterpreter/openinterpreter](https://github.com/openinterpreter/openinterpreter) | `e764363351a08c72c5788feb509ef14ef41a66c2` | Apache-2.0 | `logo/light.svg` and `logo/dark.svg` | Unified the two stroke colors as `currentColor` so the official ring adapts to Buzz themes |
